...
proc:
  ...
  | WHILE; cell = cell; CAS; term = term; proc = proc_in_block
    { P_while_cell_cas { label = None; mode = `Matching; cell; term; proc; next = P_null; } }
  | WHILE; cell = cell; CAS; term = term; proc = proc_in_block; SEMICOLON; next = proc
    { P_while_cell_cas { label = None; mode = `Matching; cell; term; proc; next; } }
  | label = STRING; COLON; WHILE; cell = cell; CAS; term = term; proc = proc_in_block
    { P_while_cell_cas { label = Some label; mode = `Matching; cell; term; proc; next = P_null; } }
  | label = STRING; COLON; WHILE; cell = cell; CAS; term = term; proc = proc_in_block; SEMICOLON; next = proc
    { P_while_cell_cas { label = Some label; mode = `Matching; cell; term; proc; next; } }
  | WHILE; NOT; cell = cell; CAS; term = term; proc = proc_in_block
    { P_while_cell_cas { label = None; mode = `Not_matching; cell; term; proc; next = P_null; } }
  | WHILE; NOT; cell = cell; CAS; term = term; proc = proc_in_block; SEMICOLON; next = proc
    { P_while_cell_cas { label = None; mode = `Not_matching; cell; term; proc; next; } }
